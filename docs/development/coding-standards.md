...
Code should be readable, explicit, testable, and safe. Prefer small modules, clear types, explicit error handling, and domain-specific names. Avoid broad utility modules that hide product logic.
