...
Stream large files, avoid loading full bases into memory, use JSONL for records, batch API writes, throttle API requests, and keep the UI responsive during long-running jobs.
