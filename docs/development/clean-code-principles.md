...
Use names that describe intent, keep functions small, separate commands from queries, avoid hidden side effects, prefer composition over large conditional blocks, and make invalid states difficult to represent.
