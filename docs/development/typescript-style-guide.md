...
Use strict TypeScript, typed command wrappers, discriminated unions for UI state, and clear view models. Avoid `any` except at validated external boundaries. Keep API response parsing explicit.
