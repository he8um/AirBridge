...
Use structured logs, job IDs, sanitized request summaries, and report files. Debug restore from package fixtures before using live Airtable write operations.
