...
Use `rustfmt`, `clippy`, explicit domain types, structured errors, and `Result` for fallible operations. Keep async boundaries clear. Avoid panics in product paths. Use streaming IO for large backup files.
