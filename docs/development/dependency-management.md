...
Prefer well-maintained dependencies with compatible licenses. Avoid adding dependencies for small utilities. Review security advisories and keep the dependency tree understandable.
