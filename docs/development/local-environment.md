...
Use a small test Airtable base for development. Never develop against production bases first. Keep tokens local, use limited scopes when possible, and keep sample backup packages synthetic.
