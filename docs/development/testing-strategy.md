...
Test package validation, schema mapping, compatibility rules, record serialization, restore planning, error mapping, and redaction. Use synthetic fixtures. Avoid real tokens in tests.
