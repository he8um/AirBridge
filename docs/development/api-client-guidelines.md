...
The Airtable client should centralize authentication headers, request limiting, retries, pagination, batching, and error mapping. Higher-level modules should not build raw HTTP requests directly.
