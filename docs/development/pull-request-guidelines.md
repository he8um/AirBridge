...
Pull requests should be scoped, documented, tested, and linked to issues when relevant. UI changes should include screenshots. Backup and restore changes should describe safety implications.
