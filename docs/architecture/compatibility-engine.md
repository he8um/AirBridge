...
The compatibility engine maps Airtable field types to AirBridge support statuses. It generates backup compatibility and restore compatibility reports. It must be data-driven so support can be updated without scattering field rules across the restore engine.
