...
Releases should be built through GitHub Actions for macOS, Windows, and Linux. Each release should include installers, checksums, release notes, and known limitations. Early releases may be unsigned; signed builds are a later stability milestone.
