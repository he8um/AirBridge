...
The Rust core should be organized by domain: Airtable client, backup engine, restore engine, compatibility engine, job runner, storage, and security. Domain modules should expose small interfaces and return structured errors. Restore planning and restore execution should be separate modules.
