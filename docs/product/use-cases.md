...
Use cases include local archival, pre-change backup, migration rehearsal, disaster recovery rehearsal, schema inspection, compliance-friendly local snapshots, and consultant handoff packages.
