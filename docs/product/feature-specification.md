...
Features are grouped into connection management, backup, package inspection, validation, restore planning, restore execution, reporting, security, and settings.
