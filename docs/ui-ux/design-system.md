...
Define consistent spacing, typography, button hierarchy, status colors, banners, cards, tables, dialogs, and report views. Keep dangerous actions visually distinct.
