...
Long-running jobs should show current phase, item progress, retry status, warnings, and cancel options. Avoid indefinite spinners for backup and restore jobs.
