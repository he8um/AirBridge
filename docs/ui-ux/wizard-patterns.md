...
Backup and restore should use step-by-step wizards. Each step must have a clear purpose, validation, and back navigation. Restore must include a review step before writes.
