...
The restore flow should guide the user from package selection to validation, compatibility review, destination selection, dry-run, confirmation, progress, and report.
