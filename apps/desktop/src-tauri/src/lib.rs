...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::restore::verify_destructive_operation_policy_gate,
            commands::restore::verify_attachment_upload_policy_gate,
            commands::restore::verify_schema_record_order_policy_gate,
            ...
            commands::restore::verify_final_validation_policy_gate,
            commands::restore::verify_write_phase_ordering_policy_gate,
            commands::restore::verify_failure_modes_policy_gate,
            commands::restore::verify_rollback_limitation_policy_gate,
            commands::restore::verify_final_validation_enforcement_policy_gate,
            commands::restore::verify_sensitive_data_safety_policy_gate,
            commands::restore::verify_attachment_phase_disabled_policy_gate,
            commands::restore::verify_live_write_readiness_policy_gate,
            ...
            commands::restore::preview_final_validation_execution_gate,
            commands::restore::store_restore_checkpoint_metadata,
